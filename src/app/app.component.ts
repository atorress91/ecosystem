...
export class AppComponent implements OnInit {
  ...
  constructor(public _router: Router, location: PlatformLocation, private sessionService: SessionService, private renderer: Renderer2, @Inject(DOCUMENT) private document: Document) {
